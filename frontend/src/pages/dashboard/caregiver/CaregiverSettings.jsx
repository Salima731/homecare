...
import { 
  Settings, Lock, Bell, Eye, 
  Shield, Globe, Smartphone, Save,
          ...
          {activeTab === 'Notifications' && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="card p-8 space-y-8">
              ...
              <div className="space-y-4">
                {[
                  { title: 'New Job Alerts', desc: 'Get notified when a new booking is assigned to you.' },
                  { title: 'Message Notifications', desc: 'Receive alerts when clients send you a message.' },
                  { title: 'Payout Updates', desc: 'Get notified when your earnings are processed.' },
                  { title: 'Platform News', desc: 'Occasional updates about new features and tips.' }
                ].map((item, i) => (
